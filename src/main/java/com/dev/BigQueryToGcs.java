...
public class BigQueryToGcs {
    ...
    // this method will convert RowTable into json String
    public static PCollection<String> ParseIntoJson(PCollection<TableRow> record)
    {
        return record.apply("JsonTransform", AsJsons.of(TableRow.class));
    }
  ...
  */
        ...
        PCollection<String> jsonForm = ParseIntoJson(rows);
